...
def open_screen_for_pattern_detection(root, go_back_func, create_main_screen_func):
    ...
    button_select_input = ctk.CTkButton(main_frame, text="Select Input File", command=lambda: import_txt_file_detection())
    ...
    button_export = ctk.CTkButton(main_frame, text="Export", command=lambda: exportToXML_2(), state='enabled')
